...
Optional:
  --output-dir       Output directory (default: /tmp/feather-gha-inputs-<timestamp>)
...
Example:
  ./Resources/Scripts/generate.github.action.inputs.sh \
    ...
    --mobileprovision ./Certificates/Feather_AdHoc.mobileprovision \
...
P12_PASSWORD=""
PROFILE_FILE=""
OUTPUT_DIR="/tmp/feather-gha-inputs-$(date +%Y%m%d-%H%M%S)"
OTA_BASE_URL=""
BUNDLE_ID_OVERRIDE=""
